...
const supForm = useForm({
    employee_id:      null,
    cp_assignment_id: null,
    start_date:       null,
})

const tcForm = useForm({
    employee_ids:       [],
    sup_assignment_id:  null,
    start_date:         null,
})
        ...
        <div class="min-h-screen bg-slate-50 p-8">
            ...
            <div class="space-y-6">
                ...
                >
                    ...
                    <!-- Arbre vide -->
                    <div v-if="campaign.tree.length === 0" class="px-6 py-8 text-center text-slate-400 text-sm">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-400">Depuis {{ new Date(cp.start_date).toLocaleDateString('fr-FR') }}</p>
                                    </div>
                                </div>
                                <Button
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-slate-400">Depuis {{ new Date(sup.start_date).toLocaleDateString('fr-FR') }}</p>
                                            </div>
                                        </div>
                                        <Button
            ...
            <!-- ─── Dialog Confirmation Libération ────────────────────────────── -->
