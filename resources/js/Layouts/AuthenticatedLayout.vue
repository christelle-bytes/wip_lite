...
<template>
    <div class="h-screen bg-slate-50 flex overflow-hidden">
        <!-- Sidebar -->
        <aside
            class="w-64 bg-slate-900 text-white hidden sm:flex flex-col shadow-xl h-full flex-shrink-0"
        >
            ...
            <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
                ...
                <div
                    class="pt-4 pb-2 px-4 text-[10px] font-bold uppercase tracking-widest text-slate-500"
                >
                    Gestion
                </div>
                ...
                <template v-if="roleName === 'ADMIN'">
                    ...
                    >
                        <i
                            class="pi pi-user-plus mr-3 text-lg"
                            :class="[
                                route().current('users.*')
                                    ? 'text-teal-400'
                                    : 'text-slate-500 group-hover:text-slate-300',
                    ...
                    >
                        <i
                            class="pi pi-users mr-3 text-lg text-slate-500 group-hover:text-slate-300"
                        ></i>
                        Employés
                    </Link>
                    <Link
                    ...
                    >
                        <i
                            class="pi pi-calendar mr-3 text-lg text-slate-500 group-hover:text-slate-300"
                        ></i>
                        Plannings
                    </Link>
                    <Link
                    ...
                    >
                        <i
                            class="pi pi-clock mr-3 text-lg text-slate-500 group-hover:text-slate-300"
                        ></i>
                        Heures
                    </Link>
                    <Link
                    ...
                    >
                        <i
                            class="pi pi-file-edit mr-3 text-lg text-slate-500 group-hover:text-slate-300"
                        ></i>
                        Feuille d'heures
                    </Link>
                    <Link
                    ...
                    >
                        <i
                            class="pi pi-history mr-3 text-lg"
                            :class="[
                                route().current('admin.logs')
                                    ? 'text-teal-400'
                                    : 'text-slate-500 group-hover:text-slate-300',
                ...
                <template v-else-if="roleName === 'CP'">
                    ...
                    >
                        <i
                            class="pi pi-flag mr-3 text-lg text-slate-500 group-hover:text-slate-300"
                        ></i>
                        Campagnes
                    </Link>
                    ...
                    >
                        <i
                            class="pi pi-link mr-3 text-lg text-slate-500 group-hover:text-slate-300"
                        ></i>
                        Affectations
                    </Link>
                    <Link
            ...
            <div class="p-4 border-t border-slate-800/50">
                <div class="bg-slate-800/30 rounded-xl p-4">
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="h-8 w-8 rounded-full bg-teal-500 flex items-center justify-center text-xs font-bold text-white"
                        >
                            {{ user?.employee?.first_name?.charAt(0) || "U" }}
                        </div>
                        <div class="flex-1 min-w-0">
                            <p
                                class="text-xs font-bold text-slate-200 truncate"
                            >
                                {{
                                    user?.employee
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            >
                <div class="flex items-center gap-4">
                    <button
                        class="sm:hidden text-slate-500 hover:text-slate-700"
                    >
                        <i class="pi pi-bars text-xl"></i>
                    </button>
                    <div
                        class="text-slate-400 text-sm hidden md:flex items-center gap-2"
                    >
                ...
                <div v-if="showLogoutButton" class="flex items-center gap-6">
                    ...
                    <Dropdown align="right" width="80">
                        <template #trigger>
                            <button
                                class="relative text-slate-400 hover:text-teal-600 transition-colors p-2"
                            >
                        ...
                        <template #content>
                            <div class="w-80">
                                <div
                                    class="px-4 py-3 border-b border-slate-100 flex justify-between items-center"
                                >
                                    <h3
                                ...
                                <div class="max-h-96 overflow-y-auto">
                                    ...
                                    >
                                        <i
                                            class="pi pi-bell-slash text-slate-200 text-3xl mb-2"
                                        ></i>
                                        <p
                                    ...
                                    >
                                        <div class="flex gap-3">
                                            <div
                                                ...
                                                class="h-2 w-2 rounded-full mt-1.5 flex-shrink-0"
                                            ></div>
                                            <div class="flex-1">
                                                <p
                                                    class="text-xs font-bold text-slate-800 mb-0.5 group-hover:text-teal-600 transition-colors"
                                                >
                                                    {{
                                                        notif.data.title ||
                                                        "Notification"
                                                ...
                                                <p
                                                    class="text-[11px] text-slate-500 leading-relaxed mb-1"
                                                >
                                                    {{ notif.data.message }}
                                                </p>
                                                <p
                                ...
                                <div
                                    class="px-4 py-2 bg-slate-50 text-center rounded-b-lg"
                                >
                                    <button
                                        class="text-[10px] font-black text-slate-500 uppercase tracking-widest hover:text-slate-700 transition-colors"
                                    >
                    ...
                    <Dropdown align="right" width="48">
                        <template #trigger>
                            <button class="flex items-center gap-2 group">
                                <div
                                    class="h-8 w-8 rounded-lg bg-slate-100 flex items-center justify-center text-slate-500 group-hover:bg-teal-50 group-hover:text-teal-600 transition-all"
                                >
                                    <i class="pi pi-user text-sm"></i>
                                </div>
                                <i
                                    class="pi pi-chevron-down text-[10px] text-slate-400 group-hover:text-slate-600"
                                ></i>
                            </button>
                        </template>
                        ...
                        <template #content>
                            ...
                            >
                                <i
                                    class="pi pi-cog mr-2 text-xs text-slate-400"
                                ></i>
                                Paramètres
                            </DropdownLink>
                            <DropdownLink
                                ...
                                method="post"
                                as="button"
                                class="text-rose-600 hover:bg-rose-50 border-t border-slate-50 w-full text-left"
                                @click="() => (window.location.href = '/')"
                            >
                                <i class="pi pi-power-off mr-2 text-xs"></i>
                                Déconnexion
                            </DropdownLink>
                        </template>
                    </Dropdown>
